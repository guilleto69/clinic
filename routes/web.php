...
//backoffice
 Route::group(['middleware' => ['auth'], 'as' => 'backoffice.'], function () {
    ...
    Route::get('patient/{user}/appointment', 'PatientController@back_appointments')->name('patient.appointments');
    Route::get('patient/{user}/invoice', 'PatientController@back_invoices')->name('patient.invoices');
